      ...
      <div className="my-notes-5 screen">
        ...
        <div className="nav-bar-9">
          <div className="overlap-group5-2">
            <div className="text-21">
              ...
              <Link to="/about-us">
                <div className="about-us-10 montserrat-medium-black-20px">
                  {aboutUs}
                </div>
              </Link>
              <Link to="/help">
                <div className="help-11 montserrat-medium-black-20px">
                  {help}
                </div>
              </Link>
            ...
            <img className="line-8-1" alt="" src={line8} />
          </div>
          <Link to="/home">
            <img className="image-1-10" alt="" src={image1} />
          </Link>
        </div>
        <div className="my-notes-7 montserrat-extra-bold-black-50px">
          {myNotes}
        </div>
        <div className="jump-back-in-with-a montserrat-medium-nobel-20px">
          {jumpBackInWithA}
        </div>
        <div className="flex-row-7">
          <Link to="/sample-list-grocery-list">
            <div className="grocery-list-2">
              <div className="overlap-group-10">
                ...
                >
                  <div className="grocery-list-3 montserrat-extra-bold-white-20px">
                    {groceryList}
                  </div>
                </div>
                <div className="text-19 montserrat-extra-bold-black-72px">
                  {text2}
                </div>
              </div>
            </div>
          ...
          <div className="overlap-group2-6">
            ...
            >
              <div className="homework montserrat-extra-bold-white-20px">
                {homework}
              </div>
            </div>
            <div className="text-19 montserrat-extra-bold-black-72px">
          ...
          <Link to="/sample-note-hikes">
            <div className="hikes-to-try-2">
              <div className="overlap-group-10">
                ...
                >
                  <div className="hikes-to-try-3 montserrat-extra-bold-white-20px">
                    {hikesToTry}
                  </div>
                </div>
                <div className="text-20 montserrat-extra-bold-black-72px">
                  {text4}
                </div>
              </div>
            </div>
          ...
          <Link to="/new-note">
            <div className="hikes-to-try-4">
              <div className="overlap-group-10">
                ...
                >
                  <div className="new-note-3 montserrat-extra-bold-white-20px">
                    {newNote}
                  </div>
                </div>
                <div className="text-20 montserrat-extra-bold-black-72px">
        ...
        <div
          className="overlap-group6-2"
          style={{ backgroundImage: `url(${overlapGroup6})` }}
        >
          <img className="line-3-7" alt="" src={line3} />
        </div>
        <div className="overlap-group-container-8">
          ...
          >
            <img className="image-4-5" alt="" src={image4} />
          </div>
          ...
          <div
            className="overlap-group7-2"
            style={{ backgroundImage: `url(${overlapGroup7})` }}
          >
            <img className="image-5-5" alt="" src={image5} />
          </div>
        </div>
      </div>
    </div>
