...
const bottomDescriptionData = {
  ...
  weBuiltThisApplic: (
    <>
      ...
      in a<br />
      simple way that suites you best.
    </>
  ),
...
const homeData = {
  ...
  trueMinimalismMeetsProductivity: (
    <>
      True Minimalism
      <br />
      Meets Productivity.
...
const helpData = {
  ...
  createAnAccountIf:
    "Create an account if you haven’t yet. You will be prompted to make a username, provide your email, and create a password.",
  rectangle2: "/img/rectangle-2-5@2x.png",
  step1: "Step 1",
  selectFromAListO:
    "Select from a list of provided templates or create your one. You can create a grocery list, to do list, study guide, and more.",
...
const myNotesData = {
  ...
  myNotes: "My Notes",
  jumpBackInWithA:
    "Jump back in with a previously created note, or get started with a new one.",
